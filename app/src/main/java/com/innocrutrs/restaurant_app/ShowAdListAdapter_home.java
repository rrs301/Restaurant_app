 ...
 */
public class ShowAdListAdapter_home extends RecyclerView.Adapter<CustomViewHolder> {
  ...
  //  InterstitialAd mAd;
    ...
    public ShowAdListAdapter_home(Context context, List<FeedItem> feedItemList, RecyclerView rv) {
 ...
 //   int conditionn=HomePage.condition;
    ...
    public CustomViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
       // MobileAds.initialize((mContext), String.valueOf(R.string.Admob_App_Id));
            ...
            View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.restaurant_list_layout_home, null);
...
//        feedItemList = ShowAdsList.feedsList;
//        if (text.length() > 0) {
//            List<FeedItem> filterd = new ArrayList<FeedItem>();
//            for (int i = 0; i < feedItemList.size(); i++) {
//                if (feedItemList.get(i).getRestaurantTitle().toLowerCase().startsWith(text.toLowerCase())) {
